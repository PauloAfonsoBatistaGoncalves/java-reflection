	...
	public String converte(Object objeto) {
		...
		try {
			...
			if(objeto instanceof Collection) {
				...
				NomeTagXml anotacaoClasse = 
						classeObjeto.getDeclaredAnnotation(NomeTagXml.class);
				
				String nomeClasse = 
						anotacaoClasse == null ? classeObjeto.getName() : anotacaoClasse.value();
				...
				for(Field atributo : classeObjeto.getDeclaredFields()) {
					...
					NomeTagXml anotacaoAtributo = 
							atributo.getDeclaredAnnotation(NomeTagXml.class);
